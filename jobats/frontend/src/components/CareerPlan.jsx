      ...
      return (
        <div key={index} style={{ marginBottom: '30px' }}>
          {lines.map((line, lineIndex) => {
            ...
            if (/^\*\s{3}/.test(trimmedLine) || trimmedLine.startsWith('- ')) {
              return (
                <h4 key={lineIndex} style={{
                  ...
                  {trimmedLine.replace(/^\*\s{3}|^- /, '').replace(/\*\*/g, '')}
                </h4>
              );
            }
            ...
            if (trimmedLine.match(/^\s{4}\*/)) {
              return (
                <div key={lineIndex} style={{
                  ...
                  <span>{trimmedLine.replace(/^\s{4}\*\s{3}/, '').replace(/\*\*/g, '')}</span>
                </div>
              );
            }
